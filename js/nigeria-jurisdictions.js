/**
 * AGORA LENS - NIGERIAN JURISDICTION REGISTRY
 * All 36 states plus the Federal Capital Territory, each mapped to its
 * constituent Local Government Areas (774 nationwide).
 *
 * State keys are canonical short names (no " State" suffix); use
 * AgoraApp.normalizeStateName() when matching against record data that may
 * carry the suffix or an FCT variant.
 */
...
/**
 * Names used in legacy records that don't match the canonical LGA spelling.
 * Keyed by lowercased alias.
 */
const NIGERIA_LGA_ALIASES = {
